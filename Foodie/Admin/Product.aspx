        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    document.getElementById('<%= imgProduct.ClientID %>').style.width = "200px";
                    document.getElementById('<%= imgProduct.ClientID %>').style.height = "200px";
                };
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                            ErrorMessage="Ürün ismi gereklidir" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                            placeholder="Ürün açıklaması giriniz." TextMode="MultiLine"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                            ErrorMessage="Ürün açıklaması Gereklidir! " ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                            placeholder="Ürün fiyatı giriniz"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                            ErrorMessage="Ürün fiyatı gereklidir! " ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtPrice"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                            ErrorMessage="Fiyat ondalık sayı şeklinde olmalıdır!" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                                            ErrorMessage="Ürün miktarı gereklidir! " ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtQuantity"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Miktar negatif sayı olamaz!" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                                            ErrorMessage="Ürün kategorisi gereklidir! " ForeColor="Red" Display="Dynamic"
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Düzenle" runat="server" CssClass="badge badge-primary" CausesValidation="false"
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Sil" runat="server" CommandName="delete"
                                                                        ...
                                                                        OnClientClick="return confirm('Bu Ürünü Silmek İstediğinizden Emin Misiniz?');" CausesValidation="false">
                                                                        <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>

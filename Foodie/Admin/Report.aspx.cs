    ...
    public partial class Report : System.Web.UI.Page
    {
        ...
        private void getReportData(DateTime fromDate, DateTime toDate)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblTotal.Text = "Satış Maliyeti : ₺" + grandTotal;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Bitiş Tarihi geçerli tarihten büyük olamaz!'); </script>");
            }
            else if (fromDate > toDate)
            {
                Response.Write("<script>alert('Başlangıç Tarihi, Bitiş Tarihinden sonra olamaz!'); </script>");
            }
            else
            {

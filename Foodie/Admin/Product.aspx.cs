    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (fuProductImage.HasFile)
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Lütfen img, png veya jpeg formatında bir görsel ekleyiniz.";
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    con.Open();
                    cmd.ExecuteNonQuery();
                    actionName = productId == 0 ? "Ekleme" : "Güncelleme";
                    lblMsg.Visible = true;
                    lblMsg.Text = "Ürün " + actionName + " Başarılı!";
        ...
        protected void rProduct_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "delete")
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    lblMsg.Visible = true;
                    lblMsg.Text = "Ürün silme işlemi başarılı!";
                    lblMsg.CssClass = "alert alert-success";
                    getProducts();
                }
                catch (Exception ex)
        ...
        protected void rProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (Convert.ToInt32(lblQuantity.Text) <= 5)
                {
                    ...
                    lblQuantity.ToolTip = "Ürünün stoğu tükenmek üzere!";
                }
            }

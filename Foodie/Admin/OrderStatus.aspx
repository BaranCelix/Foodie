                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8">
                                            <h4 class="sub-title">Siparişler</h4>
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="table-plus">Sipariş No.</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %>'
                                                                        CssClass='<%# Eval("Status").ToString() == "Beklemede" ? "badge badge-success" : "badge badge-warning" %>'>
                                                                    </asp:Label>
                                                                </td>
                                                                <td><%# Eval("Name") %></td>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4 mobile-inputs">
                                            <asp:Panel ID="pUpdateOrderStatus" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvDdlOrderStatus" runat="server" ForeColor="Red" ControlToValidate="ddlOrderStatus"
                                                               ErrorMessage="Sipariş Durumu gereklidir." SetFocusOnError="true" Display="Dynamic" InitialValue="0" ></asp:RequiredFieldValidator>
                                                ...
                                                <div class="pb-5">
                                                    <asp:Button ID="btnUpdate" runat="server" Text="Güncelle" CssClass="btn btn-primary"
                                                        OnClick="btnUpdate_Click" />
                                                    &nbsp;
                                                    <asp:Button ID="btnCancel" runat="server" Text="İptal Et" CssClass="btn btn-primary"

        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                        " Kayıt başarılı! <b><a href='Login.aspx'>Giriş yapmak için buraya tıklayın</a></b>" :
                        " Ayrıntılar güncellendi! <b><a href='Profile.aspx'>Profilinize gitmek için buraya tıklayın</a></b>";
...

                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUsername.Text.Trim() + "</b> kullanılıyor. Lütfen başka bir kullanıcı adı deneyin.";
                        lblMsg.CssClass = "alert alert-danger";
